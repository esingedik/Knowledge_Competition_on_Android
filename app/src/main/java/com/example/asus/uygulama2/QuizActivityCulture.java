...
public class QuizActivityCulture extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        DbHelperCulture db=new DbHelperCulture(this);
        ...
        butAnswer.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                if(correctAns.equals(answer.getText())) {
                    preferences = getSharedPreferences("GenelCultureTrueScore", MODE_PRIVATE);
                    editor = preferences.edit();

                    trueScore = preferences.getString("GenelCultureTrueScore", "");
                    trueScore = String.valueOf(Integer.parseInt(trueScore) + 1);
                    editor.putString("GenelCultureTrueScore", trueScore);
                    editor.commit();
                ...
                {
                    preferences = getSharedPreferences("GenelCultureFalseScore",MODE_PRIVATE);
                    editor = preferences.edit();

                    falseScore =  preferences.getString("GenelCultureFalseScore", "");
                    falseScore = String.valueOf(Integer.parseInt(falseScore) + 1);
                    editor.putString("GenelCultureFalseScore", falseScore);
                    editor.commit();
        ...
        butFinish.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view) {
                Intent resultIntent = new Intent(getApplicationContext(),ResultActivityCulture.class);
