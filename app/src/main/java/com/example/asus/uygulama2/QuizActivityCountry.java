...
public class QuizActivityCountry extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        DbHelperCountry db=new DbHelperCountry(this);
        ...
        butAnswer.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                if(correctAns.equals(answer.getText())) {
                    preferences = getSharedPreferences("CountryTrueScore", MODE_PRIVATE);
                    editor = preferences.edit();

                    trueScore = preferences.getString("CountryTrueScore", "");
                    trueScore = String.valueOf(Integer.parseInt(trueScore) + 1);
                    editor.putString("CountryTrueScore", trueScore);
                    editor.commit();
                ...
                {
                    preferences = getSharedPreferences("CountryFalseScore",MODE_PRIVATE);
                    editor = preferences.edit();

                    falseScore =  preferences.getString("CountryFalseScore", "");
                    falseScore = String.valueOf(Integer.parseInt(falseScore) + 1);
                    editor.putString("CountryFalseScore", falseScore);
                    editor.commit();
        ...
        butFinish.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view) {
                Intent resultIntent = new Intent(getApplicationContext(),ResultActivityCountry.class);
