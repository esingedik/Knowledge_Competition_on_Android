...
public class QuizActivityAnimal extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        DbHelperAnimals db=new DbHelperAnimals(this);
        ...
        butAnswer.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                if(correctAns.equals(answer.getText())) {
                    preferences = getSharedPreferences("AnimalTrueScore", MODE_PRIVATE);
                    editor = preferences.edit();

                    trueScore = preferences.getString("AnimalTrueScore", "");
                    trueScore = String.valueOf(Integer.parseInt(trueScore) + 1);
                    editor.putString("AnimalTrueScore", trueScore);
                    editor.commit();
                ...
                {
                    preferences = getSharedPreferences("AnimalFalseScore",MODE_PRIVATE);
                    editor = preferences.edit();

                    falseScore =  preferences.getString("AnimalFalseScore", "");
                    falseScore = String.valueOf(Integer.parseInt(falseScore) + 1);
                    editor.putString("AnimalFalseScore", falseScore);
                    editor.commit();
        ...
        butFinish.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view) {
                Intent resultIntent = new Intent(getApplicationContext(),ResultActivityAnimal.class);
