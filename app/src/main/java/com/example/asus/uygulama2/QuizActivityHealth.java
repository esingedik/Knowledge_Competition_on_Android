...
public class QuizActivityHealth extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        DbHelperHealth db=new DbHelperHealth(this);
        ...
        butAnswer.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                if(correctAns.equals(answer.getText())) {
                    preferences = getSharedPreferences("HealthTrueScore", MODE_PRIVATE);
                    editor = preferences.edit();

                    trueScore = preferences.getString("HealthTrueScore", "");
                    trueScore = String.valueOf(Integer.parseInt(trueScore) + 1);
                    editor.putString("HealthTrueScore", trueScore);
                    editor.commit();
                ...
                {
                    preferences = getSharedPreferences("HealthFalseScore",MODE_PRIVATE);
                    editor = preferences.edit();

                    falseScore =  preferences.getString("HealthFalseScore", "");
                    falseScore = String.valueOf(Integer.parseInt(falseScore) + 1);
                    editor.putString("HealthFalseScore", falseScore);
                    editor.commit();
        ...
        butFinish.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view) {
                Intent resultIntent = new Intent(getApplicationContext(),ResultActivityHealth.class);
